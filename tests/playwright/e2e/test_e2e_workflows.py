...
class TestSubscriptionActivation:
    ...
    def test_subscriber_to_active_service_flow(self, admin_page: Page, settings):
        ...
        expect(
            admin_page.get_by_role("link", name="New").or_(admin_page.get_by_role("button", name="New")).first
        ).to_be_visible()
...
class TestBillingCycle:
    ...
    def test_payment_recording_flow(self, admin_page: Page, settings):
        ...
        expect(
            ...
            .or_(admin_page.get_by_role("button", name="New").or_(admin_page.get_by_role("button", name="Record")))
            .first
        ).to_be_visible()
