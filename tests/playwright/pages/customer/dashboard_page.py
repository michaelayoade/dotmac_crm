...
class CustomerDashboardPage(BasePage):
    ...
    def expect_service_status_visible(self) -> None:
        ...
        expect(
            self.page.locator("[data-testid='service-status']").or_(self.page.get_by_text("Service", exact=False)).first
        ).to_be_visible()
    ...
    def expect_billing_summary_visible(self) -> None:
        ...
        expect(
            ...
            .or_(self.page.get_by_text("Balance", exact=False).or_(self.page.get_by_text("Billing", exact=False)))
            .first
        ).to_be_visible()
    ...
    def get_account_balance(self) -> str:
        ...
        balance_element = self.page.locator("[data-testid='account-balance']").or_(self.page.get_by_text("$").first)
