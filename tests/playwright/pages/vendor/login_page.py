"""Vendor portal login page object."""
...
class VendorLoginPage(BasePage):
    """Page object for the vendor portal login page."""
    ...
    def expect_login_success(self) -> None:
        ...
        self.page.wait_for_url("**/vendor/dashboard**")
