...
def test_preview_requires_an_asset(db_session):
    with pytest.raises(HTTPException) as exc:
        preview_infrastructure_impact(node_id=None, basestation_id=None, db=db_session)
...
def test_preview_returns_impact_summary(db_session, _mocked_impact):
    ...
    out = preview_infrastructure_impact(node_id="node-1", basestation_id=None, db=db_session)
