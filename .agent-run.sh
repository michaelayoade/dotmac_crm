...
WORKTREE_DIR=/home/dotmac/projects/dotmac_crm/.worktrees/fix-deps-012-v2
...
LOG_FILE=/home/dotmac/projects/dotmac_crm/.seabone/logs/fix-deps-012-v2.log
TASK_ID=fix-deps-012-v2
DESCRIPTION=Add\ pip-audit\ to\ dev\ dependencies\ and\ CI\ for\ automated\ CVE\ scanning.\ Steps:\ 1\)\ Run:\ poetry\ add\ --group\ dev\ pip-audit.\ 2\)\ In\ .github/workflows/ci.yml\ find\ the\ security/bandit\ step\ and\ add\ a\ new\ step\ after\ it:\ \'name:\ Dependency\ audit\,\ run:\ pip-audit\ --strict\'.\ If\ the\ workflow\ uses\ pip\ install\,\ also\ add\ pip-audit\ to\ the\ requirements.\ 3\)\ Run:\ pip-audit\ --strict\ locally\ to\ verify\ it\ works\ and\ passes.\ 4\)\ Run:\ ruff\ check\ app/\ tests/\ \&\&\ ruff\ format\ app/\ tests/\ \(formatting\ only\,\ no\ app\ code\ changes\).\ Note:\ pip-audit\ may\ flag\ the\ same\ CVEs\ we\ are\ fixing\ in\ other\ tasks\ -\ that\ is\ expected\ and\ acceptable\ for\ now.
BRANCH=agent/fix-deps-012-v2
ENGINE=aider
MODEL=deepseek-chat
