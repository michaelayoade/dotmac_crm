...
WORKTREE_DIR=/home/dotmac/projects/dotmac_crm/.worktrees/fix-security-c1-8
...
LOG_FILE=/home/dotmac/projects/dotmac_crm/.seabone/logs/fix-security-c1-8.log
TASK_ID=fix-security-c1-8
DESCRIPTION=Add\ per-IP\ rate\ limiting\ to\ webhook\ endpoints\ \(currently\ fully\ exempt\ from\ rate\ limiting\).\ File:\ app/middleware/api_rate_limit.py.\ Steps:\ 1\)\ Read\ app/middleware/api_rate_limit.py\ to\ understand\ the\ existing\ rate\ limiting\ structure\ and\ how\ Redis\ is\ used.\ 2\)\ Add\ a\ separate\ WebhookRateLimitMiddleware\ or\ extend\ APIRateLimitMiddleware\ to\ apply\ a\ tighter\ per-IP\ rate\ limit\ \(e.g.\,\ 60\ req/min\)\ specifically\ to\ /webhooks/crm/\*\ paths\,\ independent\ of\ the\ global\ limiter.\ 3\)\ Use\ the\ existing\ Redis\ infrastructure\ already\ wired\ up\ in\ the\ middleware.\ 4\)\ Register\ the\ webhook\ rate\ limiter\ in\ app/main.py\ alongside\ the\ existing\ APIRateLimitMiddleware.\ 5\)\ Run:\ ruff\ check\ app/\ --fix\ \&\&\ ruff\ format\ app/\ \&\&\ python\ -c\ \'from\ app.main\ import\ app\'\ to\ verify\ app\ boots.
