...
WORKTREE_DIR=/home/dotmac/projects/dotmac_crm/.worktrees/fix-deps-005
...
LOG_FILE=/home/dotmac/projects/dotmac_crm/.seabone/logs/fix-deps-005.log
TASK_ID=fix-deps-005
DESCRIPTION=Upgrade\ fastapi\ to\ \>=0.115.0\ and\ uvicorn\ to\ \>=0.32.0\ to\ fix\ request\ validation\ bypass\ and\ Pydantic\ v2\ compatibility\ issues.\ Steps:\ 1\)\ In\ pyproject.toml\ update\ fastapi\ to\ \>=0.115.0.\ 2\)\ Update\ uvicorn\ to\ \>=0.32.0.\ 3\)\ Run:\ poetry\ update\ fastapi\ uvicorn.\ 4\)\ Run\ full\ test\ suite:\ pytest\ -x\ -q\ and\ check\ for\ any\ changes\ in\ 422\ validation\ response\ shape.\ 5\)\ Run:\ python\ -c\ \"from\ app.main\ import\ app\"\ to\ verify\ app\ boots.
