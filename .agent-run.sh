...
WORKTREE_DIR=/home/dotmac/projects/dotmac_crm/.worktrees/fix-security-c1-9
...
LOG_FILE=/home/dotmac/projects/dotmac_crm/.seabone/logs/fix-security-c1-9.log
TASK_ID=fix-security-c1-9
DESCRIPTION=Add\ Pydantic\ schema\ validation\ for\ JSON\ form\ fields\ in\ admin\ projects\ routes.\ File:\ app/web/admin/projects.py.\ Steps:\ 1\)\ Read\ app/web/admin/projects.py\ around\ lines\ 1360\,\ 1985\,\ 2537\ to\ see\ how\ tasks_json\ and\ mentions\ fields\ are\ parsed\ with\ json.loads\(\).\ 2\)\ Define\ Pydantic\ schemas\ \(inline\ or\ in\ a\ schemas\ file\)\ for\ the\ expected\ JSON\ structures\ —\ for\ tasks_json\ likely\ a\ list\ of\ task\ dicts\,\ for\ mentions\ likely\ a\ list\ of\ mention\ dicts.\ 3\)\ Replace\ json.loads\(\)\ calls\ with\ TypeAdapter.validate_json\(\)\ or\ Model.model_validate_json\(\)\ using\ these\ schemas.\ 4\)\ On\ ValidationError\,\ return\ HTTP\ 400\ with\ a\ clear\ error\ message\ or\ re-render\ the\ form\ with\ an\ error.\ 5\)\ Run:\ ruff\ check\ app/\ --fix\ \&\&\ ruff\ format\ app/\ \&\&\ python\ -c\ \'from\ app.main\ import\ app\'\ to\ verify\ app\ boots.
