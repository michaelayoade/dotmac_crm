...
WORKTREE_DIR=/home/dotmac/projects/dotmac_crm/.worktrees/fix-deps-006
...
LOG_FILE=/home/dotmac/projects/dotmac_crm/.seabone/logs/fix-deps-006.log
TASK_ID=fix-deps-006
DESCRIPTION=Upgrade\ weasyprint\ to\ \>=64.0\ and\ pydyf\ to\ \>=0.11.0\ to\ reduce\ PDF\ generation\ attack\ surface.\ Steps:\ 1\)\ In\ pyproject.toml\ update\ weasyprint\ to\ \>=64.0\ and\ pydyf\ to\ \>=0.11.0.\ 2\)\ Run:\ poetry\ update\ weasyprint\ pydyf.\ 3\)\ Test\ PDF\ generation\ by\ running\ any\ existing\ PDF\ generation\ tests\ or\ manually\ trigger\ a\ report/invoice\ PDF\ generation\ to\ confirm\ it\ works.
