...
WORKTREE_DIR=/home/dotmac/projects/dotmac_crm/.worktrees/fix-security-c1-7
...
LOG_FILE=/home/dotmac/projects/dotmac_crm/.seabone/logs/fix-security-c1-7.log
TASK_ID=fix-security-c1-7
DESCRIPTION=Fix\ path\ traversal\ vulnerability\ in\ delete_avatar\ function.\ File:\ app/services/avatar.py\ line\ 57.\ Steps:\ 1\)\ Read\ app/services/avatar.py\ to\ find\ delete_avatar\(\)\ around\ line\ 57.\ 2\)\ After\ the\ code\ constructs\ the\ path\ variable\ from\ the\ URL\ prefix\ strip\ +\ join\ with\ upload_dir\,\ add\ a\ safety\ check\ before\ path.unlink\(\):\ resolve\ both\ the\ constructed\ path\ and\ the\ upload_dir\ to\ absolute\ real\ paths\,\ then\ assert\ the\ file\ path\ stays\ inside\ the\ upload\ directory\ using\ Path.is_relative_to\(\).\ Raise\ a\ ValueError\ or\ return\ early\ if\ the\ path\ escapes\ the\ upload\ root.\ 3\)\ Run:\ ruff\ check\ app/\ --fix\ \&\&\ ruff\ format\ app/\ to\ check\ formatting.
