...
async def _collect_attachment_uploads(
    ...
    try:
        ...
        logger.debug("vendor_attachment_form_collection_failed", exc_info=True)
...
async def vendor_quote_add_comment(
    ...
    if mentions:
        try:
            ...
            logger.debug("vendor_quote_mention_notification_failed quote_id=%s", quote.id, exc_info=True)
