...
SETTINGS_SPECS: list[SettingSpec] = [
    ...
    SettingSpec(
        domain=SettingDomain.notification,
        key="crm_inbox_reply_reminder_delay_seconds",
        env_var=None,
        value_type=SettingValueType.integer,
        default=300,
        min_value=30,
    ...
    SettingSpec(
        domain=SettingDomain.notification,
        key="crm_inbox_reply_reminder_repeat_enabled",
        env_var=None,
        value_type=SettingValueType.boolean,
        default=False,
    ),
    SettingSpec(
        domain=SettingDomain.notification,
        key="crm_inbox_reply_reminder_repeat_interval_seconds",
        env_var=None,
        value_type=SettingValueType.integer,
        default=300,
        min_value=30,
    ...
    SettingSpec(
        domain=SettingDomain.notification,
        key="crm_inbox_notification_auto_dismiss_seconds",
        env_var=None,
        value_type=SettingValueType.integer,
        default=12,
        min_value=3,
    ...
    SettingSpec(
        ...
        env_var="PROJECTS_DEFAULT_TASK_STATUS",
        value_type=SettingValueType.string,
        default="todo",
        allowed={"backlog", "todo", "in_progress", "blocked", "done", "canceled"},
    ),
    SettingSpec(
        domain=SettingDomain.projects,
        key="default_task_priority",
        env_var="PROJECTS_DEFAULT_TASK_PRIORITY",
        value_type=SettingValueType.string,
        default="normal",
        allowed={"low", "normal", "high", "urgent"},
    ),
    ...
    SettingSpec(
        ...
        label="Projects Chart Config",
    ),
    SettingSpec(
        domain=SettingDomain.projects,
        key="kanban_config",
        env_var="PROJECTS_KANBAN_CONFIG",
        value_type=SettingValueType.json,
        default={
        ...
        label="Projects Kanban Config",
    ),
    SettingSpec(
        domain=SettingDomain.projects,
        key="gantt_config",
        env_var="PROJECTS_GANTT_CONFIG",
        value_type=SettingValueType.json,
        default={
        ...
        label="Projects Gantt Config",
    ),
    SettingSpec(
        domain=SettingDomain.projects,
        key="region_pm_assignments",
        env_var=None,
        value_type=SettingValueType.json,
        default={},
        label="Region Project Manager Assignments",
    ),
    SettingSpec(
        domain=SettingDomain.workflow,
        key="default_sla_clock_status",
        env_var="WORKFLOW_DEFAULT_SLA_CLOCK_STATUS",
        value_type=SettingValueType.string,
        default="running",
        allowed={"running", "paused", "breached", "completed"},
    ),
    SettingSpec(
        domain=SettingDomain.workflow,
        key="default_sla_breach_status",
        env_var="WORKFLOW_DEFAULT_SLA_BREACH_STATUS",
        value_type=SettingValueType.string,
        default="open",
    ...
    SettingSpec(
        domain=SettingDomain.comms,
        key="quote_banking_details",
        env_var=None,
        value_type=SettingValueType.json,
        default={},
        label="Quote Banking Details",
    ),
    SettingSpec(
        domain=SettingDomain.comms,
        key="support_email",
    ...
    SettingSpec(
        ...
        default=[
            ...
            {"name": "Swift Talk", "priority": None, "is_active": True},
            {"name": "GBB", "priority": None, "is_active": True},
            {"name": "WIOCC", "priority": None, "is_active": True},
    ...
    SettingSpec(
        ...
        env_var="SLA_BREACH_DETECTION_INTERVAL_SECONDS",
        value_type=SettingValueType.integer,
        default=1800,
        min_value=60,
    ),
    SettingSpec(
        domain=SettingDomain.workflow,
        key="sla_breach_detection_min_interval",
        env_var="SLA_BREACH_DETECTION_MIN_INTERVAL",
        value_type=SettingValueType.integer,
        default=60,
        min_value=10,
    ),
    ...
    SettingSpec(
        ...
        env_var="SPLYNX_CUSTOMER_SYNC_ENABLED",
        value_type=SettingValueType.boolean,
        default=False,
    ...
    SettingSpec(
        ...
        env_var="SPLYNX_BASIC_AUTH_TOKEN",
        value_type=SettingValueType.string,
        default=None,
        is_secret=True,
    ...
    SettingSpec(
        ...
        env_var="SPLYNX_TIMEOUT_SECONDS",
        value_type=SettingValueType.integer,
        default=30,
        min_value=5,
        max_value=120,
    ...
    SettingSpec(
        ...
        env_var="SPLYNX_SUBSCRIBER_SYNC_INTERVAL_HOURS",
        value_type=SettingValueType.integer,
        default=24,
        min_value=1,
        max_value=168,
    ...
    SettingSpec(
        domain=SettingDomain.integration,
        key="dotmac_erp_sync_interval_minutes",
        env_var="DOTMAC_ERP_SYNC_INTERVAL_MINUTES",
        value_type=SettingValueType.integer,
        default=60,
        min_value=5,
    ...
    SettingSpec(
        domain=SettingDomain.integration,
        key="dotmac_erp_shift_sync_interval_minutes",
        env_var="DOTMAC_ERP_SHIFT_SYNC_INTERVAL_MINUTES",
        value_type=SettingValueType.integer,
        default=60,
        min_value=5,
    ...
    SettingSpec(
        domain=SettingDomain.integration,
        key="dotmac_erp_shift_sync_days_ahead",
        env_var="DOTMAC_ERP_SHIFT_SYNC_DAYS_AHEAD",
        value_type=SettingValueType.integer,
        default=14,
        min_value=1,
    ...
    SettingSpec(
        domain=SettingDomain.integration,
        key="dotmac_erp_time_off_sync_days_ahead",
        env_var="DOTMAC_ERP_TIME_OFF_SYNC_DAYS_AHEAD",
        value_type=SettingValueType.integer,
        default=30,
        min_value=1,
    ...
    SettingSpec(
        domain=SettingDomain.integration,
        key="chatwoot_sync_enabled",
        env_var="CHATWOOT_SYNC_ENABLED",
        value_type=SettingValueType.boolean,
        default=False,
    ...
    SettingSpec(
        domain=SettingDomain.integration,
        key="chatwoot_access_token",
        env_var="CHATWOOT_ACCESS_TOKEN",
        value_type=SettingValueType.string,
        default=None,
        is_secret=True,
    ...
    SettingSpec(
        domain=SettingDomain.integration,
        key="chatwoot_sync_interval_minutes",
        env_var="CHATWOOT_SYNC_INTERVAL_MINUTES",
        value_type=SettingValueType.integer,
        default=60,
        min_value=5,
    ...
    SettingSpec(
        domain=SettingDomain.integration,
        key="chatwoot_max_conversations",
        env_var="CHATWOOT_MAX_CONVERSATIONS",
        value_type=SettingValueType.integer,
        default=5000,
        min_value=100,
