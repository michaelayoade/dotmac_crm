...
SETTINGS_SPECS: list[SettingSpec] = [
    ...
    SettingSpec(
        ...
        env_var="SPLYNX_MONITORING_URL",
        value_type=SettingValueType.string,
        default=None,
        label="Splynx Monitoring Endpoint URL",
        section="Splynx",
    ),
    SettingSpec(
        domain=SettingDomain.integration,
        key="splynx_monitoring_basic_auth_token",
        env_var="SPLYNX_MONITORING_BASIC_AUTH_TOKEN",
        value_type=SettingValueType.string,
        default=None,
        is_secret=True,
        label="Splynx Monitoring Basic Auth Token (base64)",
        section="Splynx",
    ),
    SettingSpec(
        domain=SettingDomain.integration,
