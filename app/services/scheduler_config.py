...
def build_beat_schedule() -> dict:
    ...
    try:
        ...
        pending_expense_refresh_enabled = _effective_bool(
            session,
            SettingDomain.integration,
            "dotmac_erp_expense_request_status_refresh_enabled",
            "DOTMAC_ERP_EXPENSE_REQUEST_STATUS_REFRESH_ENABLED",
            True,
        )
        pending_expense_refresh_interval = _effective_int(
            session,
            SettingDomain.integration,
            "dotmac_erp_expense_request_status_refresh_interval_seconds",
            "DOTMAC_ERP_EXPENSE_REQUEST_STATUS_REFRESH_INTERVAL_SECONDS",
            300,
        )
        _sync_scheduled_task(
            session,
            name="dotmac_erp_expense_request_status_refresh",
            task_name="app.tasks.integrations.refresh_pending_expense_request_erp_statuses",
            enabled=pending_expense_refresh_enabled,
