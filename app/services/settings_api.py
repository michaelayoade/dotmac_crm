...
def upsert_workflow_setting(db: Session, key: str, payload: DomainSettingUpdate):
    return _upsert_domain_setting(db, SettingDomain.workflow, key, payload)


def get_workflow_setting(db: Session, key: str):
    return _get_domain_setting(db, SettingDomain.workflow, key)
