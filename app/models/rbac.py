...
class PersonRole(Base):
    ...
    __table_args__ = (UniqueConstraint("person_id", "role_id", name="uq_person_roles_person_role"),)
...
class PersonPermission(Base):
    ...
    __table_args__ = (UniqueConstraint("person_id", "permission_id", name="uq_person_permissions_person_permission"),)
