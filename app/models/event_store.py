...
class EventStore(Base):
    ...
    subscriber_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), index=True)
    ...
    work_order_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), index=True)
